package spring.application.mybatis;
...
public class TestSqlSession {
	...
	public void testInsertMember() {
		...
		MemberVO getMember
		= session.selectOne("Member-Mapper.selectMemberByID", mockMember.getId());
